...
$$
\operatorname{E}(\hat{\bm{y}}_{t+h}|\mathcal{I}_t) = \operatorname{E}(\bm{y}_{t+h}|\mathcal{I}_t),
$$
then the projected forecasts are also unbiased:
$$
\operatorname{E}(\tilde{\bm{y}}_{t+h}|\mathcal{I}_t) = \operatorname{E}(\bm{y}_{t+h}|\mathcal{I}_t).
$$
:::
::: {.toappendix}
::: {.proof}
...
\operatorname{E}(\bm{M}\hat{\bm{y}}_{t+h}|\mathcal{I}_t) = \bm{M}\operatorname{E}(\hat{\bm{y}}_{t+h}|\mathcal{I}_t) = \bm{M}\operatorname{E}(\bm{y}_{t+h}|\mathcal{I}_t) = \operatorname{E}(\bm{M}\bm{y}_{t+h}|\mathcal{I}_t) = \operatorname{E}(\bm{y}_{t+h}|\mathcal{I}_t)
$$
:::
:::
...
$$
\operatorname{E}(\tilde{\bm{z}}_{t+h}|\mathcal{I}_t) = \operatorname{E}(\bm{z}_{t+h}|\mathcal{I}_t),
$$
provided
$$
\bm{G}\bm{S} = \bm{I}.
...
\operatorname{E}(\bm{G}\hat{\bm{y}}_{t+h}|\mathcal{I}_t) = \bm{G}\operatorname{E}(\hat{\bm{y}}_{t+h}|\mathcal{I}_t) = \bm{G}\operatorname{E}(\bm{y}_{t+h}|\mathcal{I}_t) = \operatorname{E}(\bm{G}\bm{S}\bm{z}_{t+h}|\mathcal{I}_t) = \operatorname{E}(\bm{z}_{t+h}|\mathcal{I}_t)
$$
if $\bm{G}\bm{S} = \bm{I}$.
:::
:::
